...
?>
    ...
    Or <a href="../index.php?page=register.php">register as a new user</a>.<br><br><br>
    ...
    <br><br>
    (<a href="../index.php?page=resetpw.php">request a password reset</a> if you forgot your password)<br><br><br>
<?php
    }
?>
